...
public class CartPage {
    ...
    private final By subscriptionEmailLocator = By.cssSelector("input#subscribe_email"); // fixed typo
    ...
    public void sendSubscriptionEmail(String email) {
        framework.clearAndSendKeys(subscriptionEmailLocator, email);
    }
    ...
    public List<String> getCartProductNames() {
        return framework.findElements(namesOfItemsInCartLocator)
                .stream()
                .map(WebElement::getText)
                .collect(Collectors.toList());
    }
    ...
    public void waitForProductToBeRemoved() {
        framework.waitForElementToBeInvisible(firstProductLocator); // fixed method name
    }
